...
- [`sign-text-bold-round.scad`](sign-text-bold-round.scad): creates signs similar to the ones in BigClive's video _Make DIY custom LED signage_, **not for LED neon, does not use the central config file**
